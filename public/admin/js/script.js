var App = function () {
	...
	var handleRaty = function () {
		$.fn.raty.defaults.path = '/public/js/jquery-raty/img';
		...
		$('#starHalf-demo').raty({
			path    : '/public/js/jquery-raty/img',
			half    : true,
	...
	var handleBackstretch = function () {
		 $.backstretch([
		"/public/admin/img/login/1.jpg"
		, "/public/admin/img/login/2.jpg"
		, "/public/admin/img/login/3.jpg"
		, "/public/admin/img/login/4.jpg"
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "/public/admin/css/themes/" + color + ".css");
	...
	return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="/public/admin/img/loaders/12.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
